    ...
    <>
      ...
      <div className="min-h-screen text-white relative overflow-hidden"
        ...
        <section className="py-32 px-6 relative overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-mangro font-bold text-white mb-6 sm:mb-8 text-shadow-glow animate-[fadeInUp_0.6s_ease-out] hover:scale-105 transition-transform duration-500">
              Inspired by Nature?
            </h2>
            <p className="text-xl text-white/80 font-mangro mb-12 max-w-3xl mx-auto leading-relaxed">
              Connect with me to discuss conservation projects, prints, or photography expeditions
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a href="/contact" 
                 className="relative overflow-hidden px-8 py-4 bg-white text-black font-semibold rounded-full magnetic-hover group transition-all duration-500 transform hover:scale-105 hover:bg-gray-800 hover:text-white border-2 border-transparent hover:border-white/20 animate-[fadeInUp_0.8s_ease-out] hover:shadow-lg hover:shadow-white/20">
                <span className="relative z-10 flex items-center">
                  Get In Touch
                  <svg className="ml-2 w-5 h-5 transform transition-transform group-hover:translate-x-1" 
                       fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a href="/albums" 
                 className="relative overflow-hidden px-8 py-4 bg-transparent text-white font-semibold rounded-full magnetic-hover group transition-all duration-500 transform hover:scale-105 border-2 border-white/30 hover:border-white/60 hover:bg-white/10 animate-[fadeInUp_0.8s_ease-out_0.2s] hover:shadow-lg hover:shadow-white/10">
                <span className="relative z-10 flex items-center">
                  Browse Albums
                  <svg className="ml-2 w-5 h-5 transform transition-transform group-hover:rotate-45" 
                       fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* ✅ Use your standalone Lightbox component */}
        <Lightbox
          image={selectedImage}
          isOpen={isLightboxOpen}
          onClose={closeLightbox}
