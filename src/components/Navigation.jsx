          ...
          <div className={`flex flex-col items-center justify-center h-full px-8 py-20 transition-all duration-500 delay-200 ${
            ...
            {menuItems.map((item, index) => (
              <Link
                key={item.path}
                to={item.path}
                className={`w-full max-w-xs text-center py-4 px-6 mb-4 rounded-xl font-display text-gray-990 transition-all duration-500 hover:text-white hover:bg-white/10 active:scale-95 touch-manipulation ${
