...
const content = [
  {
    ...
    content: (
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="glass-card p-4 max-w-md w-full h-auto">
          <img
            src={Image1}
            alt="Bobby Lohia"
        ...
        <div className="absolute -bottom-4 -right-4 glass-card p-3 sm:p-4">
          <div className="text-center">
            <div className="text-lg sm:text-xl font-copperplate font-bold text-white">15+</div>
            <div className="text-xs sm:text-sm text-white/70">Years Experience</div>
          </div>
        </div>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <div className="absolute -bottom-4 -left-4 glass-card p-3 sm:p-4">
          <div className="text-center">
            <div className="text-lg sm:text-xl font-copperplate font-bold text-white">200+</div>
            <div className="text-xs sm:text-sm text-white/70">Species Captured</div>
          </div>
        </div>
      </div>
    ),
  },
  {
      ...
      <div className="flex flex-col sm:flex-row gap-6">
        <a 
          ...
          className="relative overflow-hidden px-6 sm:px-8 py-3 sm:py-4 bg-white text-black font-semibold rounded-full
                     ...
                     hover:shadow-lg hover:shadow-white/20 text-center"
        >
        ...
        <a 
          ...
          className="relative overflow-hidden px-6 sm:px-8 py-3 sm:py-4 bg-transparent text-white font-semibold rounded-full
                     ...
                     hover:shadow-lg hover:shadow-white/10 text-center"
        >
          <span className="relative z-10 flex items-center justify-center text-sm sm:text-base">
            Join the Community
    ...
    content: (
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="glass-card p-4 max-w-sm w-full h-auto">
        ...
        <div className="absolute -bottom-4 -left-4 glass-card p-3 sm:p-4">
          <div className="text-center">
            <div className="text-lg sm:text-xl font-copperplate font-bold text-white">Global</div>
            <div className="text-xs sm:text-sm text-white/70">Movement</div>
          </div>
        </div>
      </div>
    ),
